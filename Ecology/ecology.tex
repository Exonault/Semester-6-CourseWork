...
След това се използва вградената MATLAB функция ode45, която решава системата, зададени в ode, в интервала на времето tspan, като използва началните стойности $N_0$. \\
...
\end{verbatim}
Който генерира следната графика: \\
...
Фазовия портрет на системата изглежда: 
\newpage
\begin{figure}[htp!]
